...
(function($){
  ...
  theme.ContactUsPopup = function() {

    var ids = [];
    var $buttons = $('.contactus__btn');
  
    $buttons.each(function() {
      var id = $(this).data('product-id');
      var modalId = 'ContactUsModal-' + id;
      var name = 'contactus-modal-' + id;
  ...
  theme.ShippingPopup = function() {

    var ids = [];
    var $buttons = $('.shipping__btn');
  
    $buttons.each(function() {
      var id = $(this).data('product-id');
      var modalId = 'ShippingModal-' + id;
      var name = 'shipping-modal-' + id;
  ...
  theme.Product = (function() {
    ...
    function Product(container) {
      ...
      this.settings = {
        ...
        productName: $container.data('product-title'),
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      availabilitySetup: function() {
        var $container = $(this.selectors.availabilityContainer);
        if ($container.length) {
      ...
      updateAvailability: function(evt) {
        ...
        this.storeAvailability.updateContent(variant.id, this.settings.productName);
      },
      ...
      updateContent: function(variantId, productTitle) {
        ...
        fetch(variantSectionUrl)
          ...
          .then(function(storeAvailabilityHTML) {
            ...
            self.container.html(storeAvailabilityHTML);
  
            // Only create drawer if have open button
            if (!self.container.find(selectors.drawerOpenBtn).length) {
              return;
            }
  
            self.drawer = new theme.Drawers('StoreAvailabilityDrawer', 'availability');
  
            self.container.find(selectors.productTitle).text(productTitle);
          });
      }
    });
  ...
  theme.CollectionSidebar = (function() {
    ...
    BlogSidebar.prototype = $.extend({}, BlogSidebar.prototype, {
      init: function() {
        // Force close the drawer if it exists
        this.onUnload();
  
        drawerStyle = this.$container.data('style') === 'drawer';
        theme.FilterDrawer = new theme.Drawers('FilterDrawer', 'blog-filters', true);
      },
  ...
  $(document).ready(function() {
    ...
    sections.register('blog-sidebar', theme.BlogSidebar);
